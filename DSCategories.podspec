...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "dasheng"
  # s.authors            = { "dasheng" => "398411773@qq.com" }
  # s.social_media_url   = "http://twitter.com/dasheng"
  ...
  s.source       = { :git => "https://github.com/walkdianzi/DSCategories.git", :commit => "09659c1970725b697036b4726b056bc28f336b93", :tag => "0.0.1" }
