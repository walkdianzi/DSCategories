#
#  Be sure to run `pod spec lint DSCategories_swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                      A short description of DSCategories_swift. 分类
                   DESC
  ...
  s.author             = { "YMY" => "398411773@qq.com" }
  # Or just: s.author    = "YMY"
  # s.authors            = { "YMY" => "398411773@qq.com" }
  # s.social_media_url   = "http://twitter.com/YMY"
